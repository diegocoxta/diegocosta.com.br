...
## 📷 Photography
![Canon Gear](/content/pages/uses/uses-photography-canon.png)
- **Camera bodies**: Canon EOS R50
- **Canon-system lenses**: 
  - Canon RF 27mm f/2.8mm STM (for street photography/everyday carry due to its small size)
...
## 🎸 Jam
![Jam items](/content/pages/uses/uses-jam.png)
